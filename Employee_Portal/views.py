...
def login(request):
    ...
    return render(request, 'Employee_Portal/login.html', {'form': form})
...
def register(request):
        ...
        return render(request, 'Employee_Portal/RegisterEmployee.html', {'form': form})
...
def home(request):
    ...
    if authenticate(empid,pwd) is True:
        ...
        return render(request,'Employee_Portal/home.html',{'Employee':Employee})
...
def logout(request):
    ...
    return render(request,'Employee_Portal/logout.html',{'next_page': settings.LOGOUT_REDIRECT_URL})
...
def performance(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
         ...
         form = e_task_form()
         return render(request, 'Employee_Portal/Add_Task.html', {'form': form ,'Employee':Employee})

def view_task_detail(request):
    empid = request.session['empid']
    Tasks  = Task.objects.filter(Emp = empid)
    return render(request,'Employee_Portal/View_Tasks.html',{'Tasks':Tasks})